...
@WebServlet("/clienteEmailValidator")
public class ClienteEmailValidator extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ClienteController clienteController;

	public ClienteEmailValidator() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		if (session != null && session.getAttribute("funcionario") != null) {
			Cliente c = clienteController.findByEmail(request
					.getParameter("email"));
			boolean text = c == null
