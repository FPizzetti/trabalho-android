...
/**
 * Servlet implementation class RelatorioStatu
 */
@WebServlet("/relatorioStatus")
public class RelatorioStatus extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String jasper = request.getContextPath() + "/report2Dac.jasper";
