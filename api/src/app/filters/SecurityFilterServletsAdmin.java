...
@WebFilter(filterName = "/SecurityFilterServletsAdmin", urlPatterns = {
		"/funcionarios", "/GerenciarFuncionarios" })
public class SecurityFilterServletsAdmin implements Filter {

	private LoginController loginController;

	public SecurityFilterServletsAdmin() {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (f != null && f.getEmail() != null && f.getIsAdmin()) {
			...
			for (Cookie c : cookies) {
				if (c.getName().equals("token") && c.getValue() != null
					...
					if (i != null && i.getIsAdmin() && i.getIsAtivo()) {
